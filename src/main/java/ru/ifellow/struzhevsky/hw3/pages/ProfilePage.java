...
public class ProfilePage {
    private final SelenideElement profileLocator = $x("//div[@class='aui-page-header-main']/h2")
            .as("Заголовок профиля");
    private final SelenideElement profileNameLocator = $x("//dd[@id='up-d-username']")
            .as("Имя профиля");
